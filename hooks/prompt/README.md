...
- [`auto-approve-readonly`](auto-approve-readonly.sh) ([catalog](../../docs/hooks.md#prompt)) — Auto-approves `Read`, `Glob`, `Grep`, `LS`, `WebSearch`, `WebFetch`, `TodoRead` so exploration doesn't block on confirmations.
